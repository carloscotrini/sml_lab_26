...
// DGP:
//   U  ~ N(0,1)
//   X1 = 2 + 0.5*U + eta1,    eta1 ~ N(0, sd=sqrt(0.3))
//   X2 = 10 + 0.3*U + eta2,   eta2 ~ N(0, sd=1)
//   eps ~ N(0, variance = 0.5*|X1|)     -> heteroscedastic
//   Y  = 50 + 8*log(X1) + 3*X2 + 2*U + eps
//   X3 = 0.9*Y + eta3,        eta3 ~ N(0, sd=2)   (a collider / post-outcome variable)
//
// Note: variances in the spec are interpreted literally — e.g. eta1 has
// variance 0.3 (sd = sqrt(0.3)), eps has variance 0.5*|X1|.

export const TRUE_BETAS = {
  intercept: 50,
  beta1: 8,   // coefficient on log(X1)
  beta2: 3,   // coefficient on X2
  betaU: 2    // coefficient on U
};
